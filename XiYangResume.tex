...
Craft platforms with which humane can control the fire of computing.

\resheading{Research Interests}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


My research interests have been focusing on programing languages, computer
architecture, and operating systems, especially micro-architecture aware
optimizations.

Now, I am focusing on the data management medium.
...
\item
	\ressubheading{University of Electronic Science and Technology of
        ...
        \begin{itemize}         
          ...
          \resitem{I did the project at NICTA's ERTOS group, University of New
...
\item
	\ressubheading{Terrain Data}{Sydney, Australia}{Engineer}{2017 - Date}
	\begin{itemize}
                \resitem {Help to create the first graphical algorithm
...
\begin{itemize}
  \item
  \ressubheadingTwo{Elefen}{\texttt{\color{blue} https://github.com/yangxi/elfen}}
  \begin{itemize}
    \resitem{Elefen is scheduler for co-running batch jobs with
      latency critical jobs. I designed,
      implemented, and maintain the project.}
  \end{itemize}
\item
  \ressubheadingTwo{SHIM}{\texttt{\color{blue} https://github.com/yangxi/SHIM}}
  \begin{itemize}
