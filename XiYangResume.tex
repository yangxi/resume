...
My research interests focus on creating new tools for understanding computer
system behavior.
...
\item
	...
	\begin{itemize}
		...
		\resitem {Evaluated overheads of managed language runtime barriers. {\bf ISMM 2012}}
...
\item
	...
	\begin{itemize}
                \resitem {Help to create the first interactive algorithm
...
\begin{itemize}
  \item
  \ressubheadingTwo{Elfen}{\texttt{\color{blue} https://github.com/yangxi/elfen}}
  \begin{itemize}
    \resitem{Elfen is a scheduler for co-running batch jobs with
      latency critical jobs.}
  \end{itemize}
\item
  \ressubheadingTwo{SHIM}{\texttt{\color{blue} https://github.com/yangxi/SHIM}}
  \begin{itemize}
    \resitem{SHIM is an open source high frequency continuous profiler.}
  \end{itemize}
\item
  \ressubheadingTwo{RTEMS on the Cortex-M3 CPU of OMAP4 SoC}{\texttt{\color{blue} https://github.com/yangxi/omap4m3}}
  \begin{itemize}
    \resitem{The OMAP4 SoC has two big Cortex-A9 cores and two small
      Cortex-M3 cores. This project ported the RTEMS to the
      small M3 cores. The RTEMS is loaded by the Linux, and communicates with the Linux
